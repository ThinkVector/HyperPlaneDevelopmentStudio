...
protected:
	double Series_OddPrime;		//continue...
	double Series_NotNumber;			// continue...
	double Series_OddNotPrime;	// continue...
	double Series_EvenNumber;		// continue...
	double Series_OddNotNumber;	// continue...
};
