...
{
	br0 = br1 = br2 = br3 = CPoint(0, 0);
	ar0 = ar1 = ar2 = ar3 = CPoint(0,0);
	r0 = r1 = r2 = r3 = CPoint(0, 0);
}
...
void HyperPlaneViewAngle::HyperPlaneViewAngular2(CDC* pDC, int line = 1)
{
	...
	{
		pDC->MoveTo(r0);
		pDC->ArcTo(r0.x - (r1.x - r0.x), r0.y - 2 * (r1.y - ar1.y - 4), r1.x, r1.y + 2 * (r1.y - ar1.y - 4), ar1.x, ar1.y, r1.x, r1.y);
		pDC->MoveTo(r1);
		pDC->LineTo(r0);

		pDC->MoveTo(r0);
		pDC->ArcTo(r0.x - (r1.x - r0.x), r0.y + 2 * (br1.y - r1.y - 4), r1.x, r1.y - 2 * (br1.y - r1.y - 4), r1.x, r1.y, br1.x, br1.y);
		pDC->LineTo(r0);
		...
		pDC->LineTo(r1);
		pDC->MoveTo(ar1);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (r2.y - ar2.y - 4), r2.x, r2.y + 2 * (r2.y - ar2.y - 4), ar2.x, ar2.y, r2.x, r2.y);
		pDC->LineTo(r2);
		pDC->LineTo(r1);
		...
		pDC->ArcTo(r0.x - (r1.x - r0.x), r0.y + 2 * (br1.y - r1.y - 4), r1.x, r1.y - 2 * (br1.y - r1.y - 4), r1.x, r1.y, br1.x, br1.y);
		pDC->MoveTo(r2);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y + 2 * (br2.y - r2.y - 4), r2.x, r2.y - 2 * (br2.y - r2.y - 4), r2.x, r2.y, br2.x, br2.y);
		pDC->LineTo(br1);

		pDC->MoveTo(ar3);
		pDC->ArcTo(r0.x - (r3.x - r0.x), r0.y - 2 * (r3.y - ar3.y - 4), r3.x, r3.y + 2 * (r3.y - ar3.y - 4), ar3.x, ar3.y, r3.x, r3.y);
		pDC->LineTo(r2);
		pDC->MoveTo(ar3);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (r2.y - ar2.y - 4), r2.x, r2.y + 2 * (r2.y - ar2.y - 4), ar2.x, ar2.y, r2.x, r2.y);
		pDC->LineTo(r2);
		...
		pDC->MoveTo(r2);
		pDC->ArcTo(r0.x - (r3.x - r0.x), r0.y + 2 * (br3.y - r3.y - 4), r3.x, r3.y - 2 * (br3.y - r3.y - 4), r3.x, r3.y, br3.x, br3.y);
		pDC->MoveTo(r2);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y + 2 * (br2.y - r2.y - 4), r2.x, r2.y - 2 * (br2.y - r2.y - 4), r2.x, r2.y, br2.x, br2.y);
		pDC->LineTo(br3);
	}
	else
	{
		...
		{
			pDC->MoveTo(r0);
			pDC->ArcTo(r0.x - (r1.x - r0.x), r0.y - 1 * (r1.y - ar1.y - 4), r1.x, r1.y + 1 * (r1.y - ar1.y - 4), r1.x, r1.y, ar1.x, ar1.y);
			pDC->LineTo(r0);
		}
		else
		{
		...
		{
			pDC->MoveTo(r0);
			pDC->ArcTo(r0.x - (r1.x - r0.x), r0.y - 1 * (br1.y - r1.y - 4), r1.x, r1.y + 1 * (br1.y - r1.y - 4), br1.x, br1.y, r1.x, r1.y);
			pDC->LineTo(r1);
			pDC->LineTo(r0);
		}
		else
		...
		pDC->MoveTo(r1);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (r2.y - ar2.y - 4), r2.x, r2.y + 2 * (r2.y - ar2.y - 4), r2.x, r2.y, ar2.x, ar2.y);
		pDC->LineTo(ar2);
		pDC->LineTo(ar1);
		pDC->MoveTo(r1);
		if (r0.y > r1.y)
		...
		pDC->MoveTo(br1);
		pDC->LineTo(br2);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (br2.y - r1.y - 4), r2.x, r2.y + 2 * (br2.y - r1.y - 4), br2.x, br2.y, r2.x, r2.y);
		pDC->LineTo(r2);
		pDC->LineTo(r1);
		pDC->MoveTo(br1);
		if (r0.y > r1.y)
		...
		pDC->MoveTo(r3);
		pDC->ArcTo(r0.x - (r3.x - r0.x), r0.y - 2 * (r2.y - ar3.y - 4), r3.x, r3.y + 2 * (r2.y - ar3.y - 4), r3.x, r3.y, ar3.x, ar3.y);
		pDC->LineTo(ar2);
		pDC->MoveTo(r3);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (r1.y - ar2.y - 4), r2.x, r2.y + 2 * (r1.y - ar2.y - 4), r2.x, r2.y, ar2.x, ar2.y);
		pDC->LineTo(ar2);

		pDC->MoveTo(br2);
		pDC->ArcTo(r0.x - (r3.x - r0.x), r0.y - 2 * (br3.y - r2.y - 4), r3.x, r3.y + 2 * (br3.y - r2.y - 4), br3.x, br3.y, r3.x, r3.y);
		pDC->LineTo(r3);
		pDC->MoveTo(br2);
		pDC->ArcTo(r0.x - (r2.x - r0.x), r0.y - 2 * (br2.y - r1.y - 4), r2.x, r2.y + 2 * (br2.y - r1.y - 4), br2.x, br2.y, r2.x, r2.y);
		pDC->LineTo(r2);
